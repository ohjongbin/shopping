	...
	<div id="main-content" class="container">
		...
		<form class="form-inline">
			<div class="form-group">
				<label for="connect">챗 봇 연 결:</label>
		...
		<form class="form-inline" onchange="handleOnChange(this)">
			<select id="content" name="content">
						<option value="">--문의 사항을 선택하세요--</option>
						
						<option value="1" selected="selected">직접입력</option>
						<option value="회원 정보 수정하려면?">회원 정보 수정하려면?</option>
						<option value="배송 얼마나 걸리나요?">배송 얼마나 걸리나요?</option>
						<option value="배송비 문의합니다">배송비 문의합니다</option>
						<option value="사이즈 문의합니다">사이즈 문의합니다</option>
						<option value="제품 관련 문의입니다">제품 관련 문의입니다</option>
