...
<h1 class="col-sm-offset-2 col-sm-10">로그인</h1>
  <form class="form-horizontal" 
    ...
    <!-- input 태그 자체가 사용자 입력 부분과 전송 기능을 제공해주는 태그이다.
    	hidden 을통해 화면에는 출력되지 않지만 데이터를 유용하게 사용 할 수 있다.
    	즉! 보이지는 않지만  name= value 형태로 서버에 데이터를 넘겨주고 있다.
    	${param.name} param = 파라미터 값으로 넘온 데이터 / name = 그 데이터 중에 이름을 갖는 데이터의 값을 가져오겠다는 뜻
     -->
    <div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        value='${c_id_val}'> <!-- 컨트롤러에서 쿠키 설정 부분의 ID 값 (RememberID기능)-->
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-8">
        ...
        <button type="button" class="btn btn-default"
         onclick="location.href='agree'">회원가입</button> <!-- http://localhost:8000/member/agree-->
